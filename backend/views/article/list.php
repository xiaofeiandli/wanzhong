    ...
    <div class="col-md-12">
        <div class="portlet box blue-hoki">
            <div class="portlet-title" style="padding-right:0;">
                <div class="caption">
                    <i class="icon-layers"></i>模版文章
                </div>
                <span class="btn blue pull-right" style="padding: 10px 14px;" data-isnews="0" id="new_article"><i class="fa fa-plus"></i> 添加文章</span>
            </div>
    ...
    <?php if(ceil($total/10)>1){?>
        <div class="col-md-7 col-sm-12">
            <ul class="pagination pull-right">
                <li class="">
                    <a href="/article/list/1<?=$geturl?>"><i class="fa fa-angle-double-left"></i></a>
                </li>
                <li class="">
                    <a href="/article/list/<?=$page-1>0?$page-1:1?><?=$geturl?>"><i class="fa fa-angle-left"></i></a>
                </li>
                <?php
                if(ceil($total/10)==2){
                    if($page==1){
                        ?>
                        <li class="active"><a href="/article/list/1<?=$geturl?>">1</a></li>
                        <li class=""><a href="/article/list/2<?=$geturl?>">2</a></li>
                        <?php
                    }
                    if($page==2){
                        ?>
                        <li class=""><a href="/article/list/1<?=$geturl?>">1</a></li>
                        <li class="active"><a href="/article/list/2<?=$geturl?>">2</a></li>
                        <?php
                    }
                    ?>
                    <?php
                ...
                if(ceil($total/10)==3){
                    for($i=1;$i<4;$i++){
                        if($page==$i){
                            ?>
                            <li class="active"><a href="/article/list/<?=$i?><?=$geturl?>"><?=$i?></a></li>
                            <?php
                        }else{
                            ?>
                            <li class=""><a href="/article/list/<?=$i?><?=$geturl?>"><?=$i?></a></li>
                            <?php
                        }
                        ?>
                        <?php
                ...
                if(ceil($total/10)>3){
                    ...
                    ?>
                    <?php if($page>1){?><li class=""><a href="/article/list/<?=$page-1?><?=$geturl?>"><?=$page-1?></a></li><?php }?>
                    <li class="<?php if(!isset($cur_page)){echo 'active';}?>"><a href="/article/list/<?=$page?><?=$geturl?>"><?=$page?></a></li>
                    <li class="<?php if(isset($cur_page)){echo 'active';}?>"><a href="/article/list/<?=$page+1?><?=$geturl?>"><?=$page+1?></a></li>
                    <?php if($page==1){?><li class=""><a href="/article/list/<?=$page+2?><?=$geturl?>"><?=$page+2?></a></li><?php }?>
                ...
                <li>
                    <a href="/article/list/<?=$page+1>ceil($total/10)?ceil($total/10):$page+1?><?=$geturl?>"><i class="fa fa-angle-right"></i></a>
                </li>
                <li>
                    <a href="/article/list/<?=ceil($total/10)?><?=$geturl?>"><i class="fa fa-angle-double-right"></i></a>
                </li>
            </ul>
        </div>
    <?php } ?>

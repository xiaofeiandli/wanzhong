...
(function (factory) {
      ...
      return function (node) {
        try{
          if(node.nodeName == "SPAN"){
            var n = (parseInt($(node).css("font-size"),10)/16).toFixed(1);
            $(node).css("font-size",n+"em");
          }
        }catch (e){
  ...
  var Style = function () {
    ...
    this.fromNode = function ($node) {
      ...
      styleInfo['font-size'] = (parseInt(styleInfo['font-size'], 10)/16).toFixed(1);
      return styleInfo;
    };
  ...
  var ImageDialog = function (context) {
    ...
    this.initialize = function () {
      ...
      var body = '<form name="upload" class='+options.myId+' enctype="multipart/form-data">'+
                 ...
                 '</div>'+*/
          '</form>';
      var footer = '<button href="#" class="btn btn-primary note-image-btn disabled" disabled style="">' + lang.image.insert + '</button>';
  ...
  var VideoDialog = function (context) {
    ...
    this.initialize = function () {
      ...
      this.$dialog = ui.dialog({
        ...
        body: body,
        footer: footer
      }).render().appendTo($container).css("background-color", "rgba(0,0,0,.5)");
    ...
    this.createVideoNode = function (url) {
      ...
      var qqRegExp = /\/\/v\.qq\.com\/x\/cover\/(\w+)\/(\w+)\.html/;
      ...
      if (ytMatch && ytMatch[1].length === 11) {
        ...
        $video = $('<video controls>')
            .attr('src', url)
            .attr('width', '100%').attr('height', '240');
      } else if(qqMatch && qqMatch){
        $video = $('<iframe webkitallowfullscreen mozallowfullscreen allowfullscreen>')
            .attr('frameborder', 0)
            .attr('height', '240')
            .attr('width', '100%')
            .attr('src', 'https://v.qq.com/iframe/player.html?vid='+ qqMatch[2] +'&tiny=0&auto=0');
      } else {
  ...
  $.summernote = $.extend($.summernote, {
    ...
    options: {
      ...
      fontSizes: ['0.8','1.0','1.2','1.4','1.6','1.8','2.0'],

...
<div class="news-page">
    <div class="container" style="min-height: 400px">
        ...
        <div class="news-header">
            <h1 class="news-title"><?php if(isset($detail['title'])){echo $detail['title'];}?></h1>
            <div class="news-info">
                <span><?php if(isset($detail['created_at'])){echo $detail['created_at'];}?></span>
                <span><i class="icon"></i><?php if(isset($detail['category_name'])){echo $detail['category_name'];}?></span>
                <span><?php if(isset($detail['source'])&&!empty($detail['source'])){echo $detail['source'];}?>
